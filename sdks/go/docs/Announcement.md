...
**AllStations** | [**[]AnnouncementAllStationsInner**](AnnouncementAllStationsInner.md) | Complete ordered station sequence of the line with coordinates — the whole line, not only the part the vehicle still has to drive.  | 
